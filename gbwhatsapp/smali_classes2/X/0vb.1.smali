...
# direct methods
.method public constructor <init>(LX/0vG;Lcom/google/firebase/iid/FirebaseInstanceId;)V
    .locals 0

    iput-object p2, p0, LX/0vb;->A05:Lcom/google/firebase/iid/FirebaseInstanceId;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/0vb;->A04:LX/0vG;
...
.method public final declared-synchronized A00()Z
    ...
    :try_start_0
    iget-boolean v0, p0, LX/0vb;->A03:Z
    ...
    :catch_0
    :try_start_2
    iget-object v0, p0, LX/0vb;->A05:Lcom/google/firebase/iid/FirebaseInstanceId;

    iget-object v0, v0, Lcom/google/firebase/iid/FirebaseInstanceId;->A01:LX/0uu;

    invoke-static {v0}, LX/0uu;->A02(LX/0uu;)V

    iget-object v1, v0, LX/0uu;->A00:Landroid/content/Context;
    ...
    :goto_1
    iput-boolean v0, p0, LX/0vb;->A02:Z
    ...
    iget-object v4, v0, LX/0uu;->A00:Landroid/content/Context;
    ...
    :goto_2
    iput-object v0, p0, LX/0vb;->A01:Ljava/lang/Boolean;
    ...
    :try_start_4
    iget-boolean v0, p0, LX/0vb;->A02:Z

    if-eqz v0, :cond_4

    new-instance v5, LX/0vh;

    invoke-direct {v5, p0}, LX/0vh;-><init>(LX/0vb;)V

    iput-object v5, p0, LX/0vb;->A00:LX/0vh;

    iget-object v4, p0, LX/0vb;->A04:LX/0vG;

    const-class v3, LX/0vi;

    iget-object v2, v4, LX/0vG;->A02:Ljava/util/concurrent/Executor;
    ...
    iget-object v1, v4, LX/0vG;->A01:Ljava/util/Map;
    ...
    iput-boolean v0, p0, LX/0vb;->A03:Z
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_1

    :cond_5
    :try_start_7
    iget-object v0, p0, LX/0vb;->A01:Ljava/lang/Boolean;
    ...
    iget-object v0, v0, LX/0uu;->A03:LX/0vN;

    invoke-virtual {v0}, LX/0vN;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, LX/0vj;

    iget-object v0, v0, LX/0vj;->A02:Ljava/util/concurrent/atomic/AtomicBoolean;

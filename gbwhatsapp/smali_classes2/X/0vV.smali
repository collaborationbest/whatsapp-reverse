...
.method public static final A00(Landroid/content/Context;LX/6AI;Z)LX/6AI;
    .locals 12
    ...
    invoke-static {p0}, LX/0vV;->A04(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {v7}, LX/0vV;->A03(Ljava/nio/channels/FileChannel;)LX/6AI;
    ...
    invoke-virtual {v8, v0, v4}, Ljava/util/Properties;->store(Ljava/io/OutputStream;Ljava/lang/String;)V
    :try_end_6
...
.method public static A01(Landroid/content/SharedPreferences;)LX/6AI;
    .locals 5

    const-string v0, "cre"

    invoke-static {v0}, LX/0vU;->A00(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {v0}, LX/0vV;->A05(Ljava/lang/String;)Ljava/security/PublicKey;

    move-result-object v0

    invoke-static {v0}, LX/0vS;->A02(Ljava/security/PublicKey;)Ljava/lang/String;
    ...
    invoke-direct {v0, v3, v1, v2}, LX/6AI;-><init>(Ljava/lang/String;J)V

    return-object v0
.end method

.method public static final A02(Ljava/io/File;)LX/6AI;
    .locals 10
    ...
    invoke-static {v5}, LX/0vV;->A03(Ljava/nio/channels/FileChannel;)LX/6AI;
...
.method public static A03(Ljava/nio/channels/FileChannel;)LX/6AI;
    .locals 5
    ...
    invoke-direct {v0, v1}, LX/0vR;-><init>(Ljava/lang/Exception;)V
...
.method public static A04(Landroid/content/Context;)Ljava/io/File;
    ...
    :goto_0
    invoke-static {p0}, LX/00F;->A01(Landroid/content/Context;)Ljava/io/File;
...
.method public static A05(Ljava/lang/String;)Ljava/security/PublicKey;
    ...
    invoke-direct {v0, p0}, LX/0vR;-><init>(Ljava/lang/Exception;)V
...
.method public static final A06(Landroid/content/Context;LX/6AI;)V
    .locals 3
    ...
    :try_start_0
    invoke-static {v2}, LX/0vV;->A01(Landroid/content/SharedPreferences;)LX/6AI;
    ...
    return-void
    :try_end_0
    .catch LX/0vR; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v0, p1, LX/6AI;->A01:Ljava/lang/String;
...
# virtual methods
.method public final A07(Landroid/content/Context;)LX/6AI;
    .locals 5
    ...
    invoke-direct {v4, v2, v0, v1}, LX/6AI;-><init>(Ljava/lang/String;J)V

    const/4 v0, 0x1

    invoke-static {p1, v4, v0}, LX/0vV;->A00(Landroid/content/Context;LX/6AI;Z)LX/6AI;
    ...
    :cond_2
    invoke-static {p1, v4}, LX/0vV;->A06(Landroid/content/Context;LX/6AI;)V

...
.method public static synthetic access$100(LX/77Z;IIJ)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/facebook/msys/mci/Execution;->executeAfterWithPriorityInternal(LX/77Z;IIJ)V
...
.method public static ensureNotOnDatabaseThread()V
    ...
    :cond_0
    const-string v1, "The task can not run on Database thread"
...
.method public static executeAfter(LX/77Z;IJ)V
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, p1, v0, p2, p3}, Lcom/facebook/msys/mci/Execution;->executeAfterWithPriority(LX/77Z;IIJ)V

    return-void
.end method

.method public static executeAfterWithPriority(LX/77Z;IIJ)V
    .locals 2
    ...
    invoke-direct/range {v1 .. v6}, LX/BXe;-><init>(LX/77Z;IIJ)V
...
.method public static executeAfterWithPriorityInternal(LX/77Z;IIJ)V
    .locals 6
...
.method public static executeAsync(LX/77Z;I)V
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, p1, v0}, Lcom/facebook/msys/mci/Execution;->executeAsyncWithPriority(LX/77Z;II)V

    return-void
.end method

.method public static executeAsyncWithPriority(LX/77Z;II)V
    .locals 2
    ...
    invoke-static {p0, p1, p2, v0, v1}, Lcom/facebook/msys/mci/Execution;->executeAfterWithPriority(LX/77Z;IIJ)V

    return-void
.end method

.method public static executePossiblySync(LX/77Z;I)V
    .locals 1
...
.method public static startExecutorThread(ILjava/lang/String;)V
    ...
    new-instance v2, LX/BXd;

    invoke-direct {v2, p0}, LX/BXd;-><init>(I)V

...
# direct methods
.method public constructor <init>(Landroid/content/Context;LX/4aG;LX/8sS;)V
    .locals 2

    invoke-direct {p0, p1, p2, p3}, LX/2Ha;-><init>(Landroid/content/Context;LX/4aG;LX/3Sq;)V

    invoke-virtual {p0}, LX/8dP;->A0w()V
    ...
    iput-object v1, p0, LX/8dP;->A03:Landroid/widget/TextView;
...
.method public A0w()V
    ...
    iget-boolean v0, p0, LX/8dP;->A02:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/8dP;->A02:Z
    ...
    invoke-static {v4}, LX/0uf;->ApX(LX/0uf;)LX/005;
    ...
    iput-object v0, p0, LX/8dP;->A01:LX/1P4;
    ...
    iput-object v0, p0, LX/8dP;->A00:LX/1P0;
...
.method public A26()V
    ...
    iget-object v0, p0, LX/8dP;->A01:LX/1P4;

    invoke-virtual {v0}, LX/1P4;->A00()Z

    move-result v4

    iget-object v1, p0, LX/8dP;->A00:LX/1P0;

    iget v0, v3, LX/8sS;->A00:I

    invoke-virtual {v1, v2, v0, v4}, LX/1P0;->A0L(LX/123;IZ)Ljava/lang/String;
    ...
    iget-object v2, p0, LX/8dP;->A03:Landroid/widget/TextView;
    ...
    invoke-direct {v0, v1, p0, v4}, LX/3Yn;-><init>(ILjava/lang/Object;Z)V
...
.method public getFMessage()LX/8sS;
    .locals 1

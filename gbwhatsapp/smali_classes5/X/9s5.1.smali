...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/9s5;->A07:Landroid/net/Uri;
    ...
    sput-object v0, LX/9s5;->A08:Landroid/net/Uri;
    ...
    sput-object v0, LX/9s5;->A05:Ljava/util/regex/Pattern;
    ...
    sput-object v0, LX/9s5;->A06:Ljava/util/regex/Pattern;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, LX/9s5;->A04:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-static {}, LX/000;->A10()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, LX/9s5;->A02:Ljava/util/HashMap;

    invoke-static {}, LX/000;->A10()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, LX/9s5;->A09:Ljava/util/HashMap;

    invoke-static {}, LX/000;->A10()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, LX/9s5;->A03:Ljava/util/HashMap;

    invoke-static {}, LX/000;->A10()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, LX/9s5;->A0A:Ljava/util/HashMap;
...
.method public static A00(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, LX/9s5;->A01(Landroid/content/ContentResolver;)V

    sget-object v3, LX/9s5;->A00:Ljava/lang/Object;
    ...
    sget-object v6, LX/9s5;->A07:Landroid/net/Uri;
...
.method public static A01(Landroid/content/ContentResolver;)V
    ...
    sget-object v0, LX/9s5;->A04:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sput-object v0, LX/9s5;->A00:Ljava/lang/Object;

    sget-object v2, LX/9s5;->A07:Landroid/net/Uri;
    ...
    sget-object v0, LX/9s5;->A02:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/AbstractMap;->clear()V

    sget-object v0, LX/9s5;->A09:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/AbstractMap;->clear()V

    sget-object v0, LX/9s5;->A03:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/AbstractMap;->clear()V

    sget-object v0, LX/9s5;->A0A:Ljava/util/HashMap;

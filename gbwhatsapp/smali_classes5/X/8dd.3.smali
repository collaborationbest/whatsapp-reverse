...
.method public constructor <init>(Landroid/content/Context;LX/4aG;LX/3Hc;LX/1W6;LX/2c4;)V
    ...
    invoke-direct/range {p0 .. p5}, LX/8do;-><init>(Landroid/content/Context;LX/4aG;LX/3Hc;LX/1W6;LX/2c4;)V

    invoke-virtual {p0}, LX/8dd;->A0w()V
...
.method public A0w()V
    ...
    iget-boolean v0, p0, LX/8dd;->A00:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/8dd;->A00:Z
    ...
    invoke-static {v1, v4, v2, v5}, LX/7vK;->A0a(LX/0vu;LX/0uf;LX/0ug;LX/2HZ;)V

    invoke-static {v4, v2, v6, v5}, LX/8dc;->A0A(LX/0uf;LX/0ug;LX/1Sx;LX/8dc;)V

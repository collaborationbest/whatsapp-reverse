...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, LX/Am9;-><init>(Z)V
...
.method public constructor <init>(Z)V
    ...
    iput-object v0, p0, LX/Am9;->A01:LX/B8Z;

    iput-boolean p1, p0, LX/Am9;->A02:Z
...
.method public A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/Ahb;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-boolean v0, p0, LX/Am9;->A02:Z

    new-instance v6, LX/AmD;

    invoke-direct {v6, v0}, LX/AmD;-><init>(Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_5
    .catch LX/96t; {:try_start_0 .. :try_end_0} :catch_6
    ...
    goto/16 :goto_6
    :try_end_5
    .catch LX/96t; {:try_start_5 .. :try_end_5} :catch_6
    ...
    :try_end_6
    .catch LX/96t; {:try_start_6 .. :try_end_6} :catch_6
    ...
    move-result-object v1
    :try_end_8
    .catch LX/96t; {:try_start_8 .. :try_end_8} :catch_6
    ...
    invoke-virtual {p0, v0, p2, p3}, LX/Am9;->A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/Ahb;)Ljava/security/cert/CertPathBuilderResult;

    move-result-object v2

    goto :goto_2
    :try_end_a
    .catch LX/96t; {:try_start_a .. :try_end_a} :catch_6
    ...
    goto :goto_4
    :try_end_b
    .catch LX/96t; {:try_start_b .. :try_end_b} :catch_6
    ...
    throw v0
    :try_end_c
    .catch LX/96t; {:try_start_c .. :try_end_c} :catch_6

    :catch_6
    move-exception v0

    iput-object v0, p0, LX/Am9;->A00:Ljava/lang/Exception;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-virtual {p0, v0, v3, p1}, LX/Am9;->A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/Ahb;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-object v1, p0, LX/Am9;->A00:Ljava/lang/Exception;
    ...
    iget-object v0, p0, LX/Am9;->A00:Ljava/lang/Exception;
...
.method public bridge synthetic engineGetRevocationChecker()Ljava/security/cert/CertPathChecker;
    ...
    iget-object v1, p0, LX/Am9;->A01:LX/B8Z;

...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lrc/whatsapp/rounded/RoundedLayout;->a:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Paint;

    invoke-direct {p1}, Landroid/graphics/Paint;-><init>()V

    iput-object p1, p0, Lrc/whatsapp/rounded/RoundedLayout;->b:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lrc/whatsapp/rounded/RoundedLayout;->c:Landroid/graphics/RectF;

    const/16 p1, 0xc

    new-array p1, p1, [F

    iput-object p1, p0, Lrc/whatsapp/rounded/RoundedLayout;->d:[F

    const/4 p1, 0x0

    iput-boolean p1, p0, Lrc/whatsapp/rounded/RoundedLayout;->e:Z
...
.method public final a()V
    ...
    iget-boolean v1, p0, Lrc/whatsapp/rounded/RoundedLayout;->g:Z
    ...
    invoke-virtual {p0, v0}, Lrc/whatsapp/rounded/RoundedLayout;->b(F)[F
    ...
    iget-object v1, p0, Lrc/whatsapp/rounded/RoundedLayout;->o:Landroid/graphics/drawable/GradientDrawable;
...
.method public final b(F)[F
    ...
    iget-object v0, p0, Lrc/whatsapp/rounded/RoundedLayout;->d:[F

    iget-boolean v1, p0, Lrc/whatsapp/rounded/RoundedLayout;->h:Z
    ...
    iget-boolean v3, p0, Lrc/whatsapp/rounded/RoundedLayout;->i:Z
    ...
    iget-boolean v3, p0, Lrc/whatsapp/rounded/RoundedLayout;->k:Z
    ...
    iget-boolean v3, p0, Lrc/whatsapp/rounded/RoundedLayout;->j:Z
...
.method public final c()V
    ...
    iput-boolean v0, p0, Lrc/whatsapp/rounded/RoundedLayout;->g:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, Lrc/whatsapp/rounded/RoundedLayout;->h:Z

    iput-boolean v1, p0, Lrc/whatsapp/rounded/RoundedLayout;->i:Z

    iput-boolean v1, p0, Lrc/whatsapp/rounded/RoundedLayout;->j:Z

    iput-boolean v1, p0, Lrc/whatsapp/rounded/RoundedLayout;->k:Z

    iput v0, p0, Lrc/whatsapp/rounded/RoundedLayout;->l:I

    iput v0, p0, Lrc/whatsapp/rounded/RoundedLayout;->m:I

    const/4 v0, 0x0

    iput v0, p0, Lrc/whatsapp/rounded/RoundedLayout;->n:F

    invoke-virtual {p0, v0}, Lrc/whatsapp/rounded/RoundedLayout;->setRoundingElevation(F)V
    ...
    invoke-virtual {p0, v1}, Lrc/whatsapp/rounded/RoundedLayout;->b(F)[F
...
.method public onLayout(ZIIII)V
    ...
    iget-object p1, p0, Lrc/whatsapp/rounded/RoundedLayout;->c:Landroid/graphics/RectF;
    ...
    iget-boolean p1, p0, Lrc/whatsapp/rounded/RoundedLayout;->e:Z
...
.method public setBackground()V
    ...
    iput-object v0, p0, Lrc/whatsapp/rounded/RoundedLayout;->o:Landroid/graphics/drawable/GradientDrawable;

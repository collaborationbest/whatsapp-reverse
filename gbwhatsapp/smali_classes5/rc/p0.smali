...
.method public constructor <init>(Landroid/app/Activity;Ljava/io/File;)V
    ...
    iput-object v0, p0, Lrc/p0;->a:Ljava/io/File;
    ...
    iput-object v0, p0, Lrc/p0;->b:Ljava/io/File;

    iput-object p1, p0, Lrc/p0;->d:Landroid/app/Activity;

    iput-object p2, p0, Lrc/p0;->e:Ljava/io/File;

    const/4 p2, 0x0

    iput-boolean p2, p0, Lrc/p0;->c:Z

    const-string v0, "voicenotechanger_tempo"

    invoke-static {v0}, Lcom/abuarab/gold/Gold;->getFloatPriv(Ljava/lang/String;)F

    move-result v0

    iput v0, p0, Lrc/p0;->g:F
    ...
    iput v0, p0, Lrc/p0;->i:F

    new-instance v0, Landroid/app/ProgressDialog;

    invoke-direct {v0, p1}, Landroid/app/ProgressDialog;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lrc/p0;->f:Landroid/app/ProgressDialog;
    ...
    invoke-direct {p2, p0, v1}, Lrc/a;-><init>(Ljava/lang/Object;I)V
...
.method public final declared-synchronized a()V
    ...
    :try_start_0
    iget-object v1, p0, Lrc/p0;->d:Landroid/app/Activity;

    new-instance v2, Lrc/o0;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lrc/o0;-><init>(Lrc/p0;I)V
    ...
    iget-object v2, p0, Lrc/p0;->e:Ljava/io/File;

    invoke-virtual {v2}, Ljava/io/File;->getAbsolutePath()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lrc/p0;->a:Ljava/io/File;
    ...
    iget-object v5, p0, Lrc/p0;->b:Ljava/io/File;
    ...
    invoke-virtual {p0}, Lrc/p0;->b()V

    :cond_0
    iget-object v3, p0, Lrc/p0;->b:Ljava/io/File;

    invoke-virtual {v3}, Ljava/io/File;->getAbsolutePath()Ljava/lang/String;

    move-result-object v3

    iget-object v5, p0, Lrc/p0;->e:Ljava/io/File;
    ...
    invoke-direct {v2, p0, v0}, Lrc/o0;-><init>(Lrc/p0;I)V
    ...
    :catch_1
    iget-object v0, p0, Lrc/p0;->d:Landroid/app/Activity;

    new-instance v1, Lrc/o0;

    const/4 v2, 0x3

    invoke-direct {v1, p0, v2}, Lrc/o0;-><init>(Lrc/p0;I)V

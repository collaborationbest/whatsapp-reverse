...
.method public static A01(Landroid/content/Context;LX/0XX;)Landroid/content/Intent;
    .locals 2
    ...
    invoke-virtual {p1}, LX/0XX;->A01()Landroid/content/pm/ShortcutInfo;
    ...
    :cond_1
    invoke-virtual {p1, v0}, LX/0XX;->A02(Landroid/content/Intent;)V

    return-object v0
.end method

.method public static A02(Landroid/content/Context;)LX/0Uy;
    .locals 6

    sget-object v0, LX/0ZW;->A00:LX/0Uy;
    ...
    invoke-static {v4, v0, v2, v1, v5}, LX/000;->A0x(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;I)Ljava/lang/reflect/Method;
    ...
    sput-object v0, LX/0ZW;->A00:LX/0Uy;
    :try_end_0
...
.method public static A03(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-direct {v0, p0, v1}, LX/0YW;-><init>(Landroid/content/Context;Landroid/content/pm/ShortcutInfo;)V
    ...
    :cond_1
    :try_start_0
    invoke-static {p0}, LX/0ZW;->A02(Landroid/content/Context;)LX/0Uy;

    move-result-object v0

    invoke-virtual {v0}, LX/0Uy;->A02()Ljava/util/List;
...
.method public static A04(Landroid/content/Context;)Ljava/util/List;
    ...
    sget-object v0, LX/0ZW;->A01:Ljava/util/List;
    ...
    sput-object v6, LX/0ZW;->A01:Ljava/util/List;
...
.method public static A05(Landroid/content/Context;)V
    ...
    invoke-virtual {v0}, LX/0Uy;->A00()Ljava/lang/Object;

    invoke-static {p0}, LX/0ZW;->A04(Landroid/content/Context;)Ljava/util/List;
...
.method public static A06(Landroid/content/Context;LX/0XX;)V
    .locals 3
    ...
    invoke-static {p0}, LX/0ZW;->A08(Landroid/content/Context;)Z
...
.method public static A07(Landroid/content/Context;Ljava/util/List;)V
    ...
    iget-object v2, v4, LX/0XX;->A0I:Landroidx/core/graphics/drawable/IconCompat;

    if-eqz v2, :cond_5

    iget v3, v2, Landroidx/core/graphics/drawable/IconCompat;->A02:I
    ...
    :cond_3
    invoke-virtual {v2, p0}, Landroidx/core/graphics/drawable/IconCompat;->A0C(Landroid/content/Context;)Ljava/io/InputStream;
    ...
    invoke-virtual {v0}, LX/0XX;->A01()Landroid/content/pm/ShortcutInfo;
    ...
    invoke-virtual {v0, p1}, LX/0Uy;->A01(Ljava/util/List;)Ljava/lang/Object;
...
.method public static A08(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v4}, LX/00G;->A01(Landroid/content/Context;Ljava/lang/String;)I

...
.method public static A00(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v0, LX/0cI;->A05:Landroid/view/View;

    if-ne v0, p0, :cond_1

    invoke-static {v2}, LX/0cI;->A00(LX/0cI;)V
    ...
    sget-object v1, LX/0cI;->A09:LX/0cI;

    if-eqz v1, :cond_2

    iget-object v0, v1, LX/0cI;->A05:Landroid/view/View;

    if-ne v0, p0, :cond_2

    invoke-virtual {v1}, LX/0cI;->A01()V
    ...
    invoke-direct {v0, p0, p1}, LX/0cI;-><init>(Landroid/view/View;Ljava/lang/CharSequence;)V

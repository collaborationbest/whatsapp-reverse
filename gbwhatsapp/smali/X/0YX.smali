...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, LX/0YX;->A01:Landroid/widget/ProgressBar;
...
.method private A01(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v0, LX/0Du;->A00:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_0

    invoke-direct {p0, v0, p2}, LX/0YX;->A01(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-interface {v1, v0}, LX/07H;->Bs6(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_3
    invoke-direct {p0, v2, v0}, LX/0YX;->A01(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, LX/0YX;->A00:Landroid/graphics/Bitmap;

    if-nez v0, :cond_5

    iput-object v5, p0, LX/0YX;->A00:Landroid/graphics/Bitmap;
...
.method public A02(Landroid/util/AttributeSet;I)V
    ...
    iget-object v6, p0, LX/0YX;->A01:Landroid/widget/ProgressBar;

    invoke-virtual {v6}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    sget-object v0, LX/0YX;->A02:[I

    const/4 v7, 0x0

    invoke-static {v1, p1, v0, p2, v7}, LX/052;->A00(Landroid/content/Context;Landroid/util/AttributeSet;[III)LX/052;

    move-result-object v8

    invoke-virtual {v8, v7}, LX/052;->A03(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v1, v0}, LX/0YX;->A01(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v8, v0}, LX/052;->A03(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-direct {p0, v0, v7}, LX/0YX;->A01(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    iget-object v0, v8, LX/052;->A02:Landroid/content/res/TypedArray;

...
# direct methods
.method public static A00(Landroid/content/Context;Landroid/text/Layout;F)Ljava/util/ArrayList;
    .locals 4
    ...
    invoke-static {p1}, LX/3Tq;->A02(Landroid/text/Layout;)Ljava/util/ArrayList;
    ...
    invoke-static/range {v1 .. v6}, LX/3Tq;->A03(Ljava/util/List;FFFFF)Ljava/util/ArrayList;
...
.method public static A01(Landroid/content/Context;Landroid/text/Layout;F)Ljava/util/ArrayList;
    .locals 8
    ...
    invoke-static/range {v5 .. v10}, LX/3Tq;->A03(Ljava/util/List;FFFFF)Ljava/util/ArrayList;
...
.method public static A02(Landroid/text/Layout;)Ljava/util/ArrayList;
    .locals 8
...
.method public static A03(Ljava/util/List;FFFFF)Ljava/util/ArrayList;
    .locals 14
    ...
    invoke-static {v6, v0, v5}, LX/3Tq;->A04([Landroid/graphics/PointF;FZ)Ljava/util/ArrayList;

    move-result-object v3

    invoke-static {v7, v0, v4}, LX/3Tq;->A04([Landroid/graphics/PointF;FZ)Ljava/util/ArrayList;
    ...
    invoke-static {v8, v3, v1}, LX/1kr;->A0l(Landroid/graphics/Path;Ljava/util/AbstractList;I)V
    ...
    invoke-static {v8, v2, v0}, LX/1kr;->A0l(Landroid/graphics/Path;Ljava/util/AbstractList;I)V
...
.method public static A04([Landroid/graphics/PointF;FZ)Ljava/util/ArrayList;
    .locals 7

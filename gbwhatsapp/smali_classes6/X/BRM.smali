...
.method public constructor <init>(Landroid/content/Context;LX/4aG;LX/2dL;)V
    ...
    invoke-direct {p0, p1, p2, p3}, LX/2Gp;-><init>(Landroid/content/Context;LX/4aG;LX/2dL;)V

    invoke-virtual {p0}, LX/BRM;->A0w()V
...
.method public A0w()V
    ...
    iget-boolean v0, p0, LX/BRM;->A00:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/BRM;->A00:Z
    ...
    invoke-static {v1, v3, v4, p0}, LX/BRS;->A0H(LX/0vu;LX/0uf;LX/1Sx;LX/2HV;)V

    invoke-static {v3, v4, p0}, LX/BRQ;->A0F(LX/0uf;LX/1Sx;LX/2Gp;)V

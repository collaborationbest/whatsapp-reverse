...
# direct methods
.method public constructor <init>(Landroid/content/Context;LX/026;LX/4aG;LX/8tF;I)V
    .locals 6

    invoke-direct {p0, p1, p3, p4}, LX/2HW;-><init>(Landroid/content/Context;LX/4aG;LX/8tH;)V

    invoke-virtual {p0}, LX/BRV;->A0w()V
    ...
    iput-object p2, p0, LX/BRV;->A04:LX/026;
    ...
    iput-object v5, p0, LX/BRV;->A05:Lcom/whatsapp/conversation/conversationrow/InteractiveMessageButton;
    ...
    iput-object v2, p0, LX/BRV;->A06:Lcom/whatsapp/conversation/conversationrow/InteractiveMessageView;
    ...
    iget-object v0, p0, LX/BRV;->A01:LX/006;
    ...
    iput-object v0, v4, LX/3TS;->A04:LX/4VG;

    invoke-super {p0}, LX/2HW;->getFMessage()LX/8tH;

    iget-object v0, p0, LX/2Ha;->A2P:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v2, v0, v4}, Lcom/whatsapp/conversation/conversationrow/InteractiveMessageView;->A03(Landroid/view/View$OnLongClickListener;LX/3TS;)V
    ...
    iput-object v4, v0, Lcom/whatsapp/conversation/conversationrow/InteractiveButtonsRowContentLayout;->A00:LX/3TS;
    ...
    iput v1, p0, LX/BRV;->A03:I

    invoke-direct {p0}, LX/BRV;->A0A()V

    iget-boolean v0, v4, LX/3TS;->A05:Z
    ...
    iput-boolean v0, v2, Lcom/whatsapp/conversation/conversationrow/ConversationRowVideo$RowVideoView;->A09:Z

    iput v1, v2, Lcom/whatsapp/conversation/conversationrow/ConversationRowVideo$RowVideoView;->A03:I
    ...
    iput v0, v2, Lcom/whatsapp/conversation/conversationrow/ConversationRowVideo$RowVideoView;->A02:I
    ...
    iput-object v0, v2, Lcom/whatsapp/conversation/conversationrow/ConversationRowVideo$RowVideoView;->A04:Landroid/graphics/drawable/Drawable;
...
.method private A0A()V
    ...
    iget-object v0, p0, LX/BRV;->A06:Lcom/whatsapp/conversation/conversationrow/InteractiveMessageView;

    invoke-virtual {v0, p0, v3}, Lcom/whatsapp/conversation/conversationrow/InteractiveMessageView;->A04(LX/2Ha;LX/3Sq;)V

    iget-object v2, p0, LX/BRV;->A05:Lcom/whatsapp/conversation/conversationrow/InteractiveMessageButton;

    iget-object v1, p0, LX/2Hb;->A0d:LX/4aG;

    iget-object v0, p0, LX/BRV;->A04:LX/026;
...
.method public A0w()V
    ...
    iget-boolean v0, p0, LX/BRV;->A02:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/BRV;->A02:Z
    ...
    iput-object v0, p0, LX/BRV;->A01:LX/006;

    invoke-static {v4}, LX/1Sx;->A0B(LX/1Sx;)LX/3El;

    move-result-object v0

    iput-object v0, p0, LX/BRV;->A00:LX/3El;
...
.method public getFMessage()LX/8tF;
    .locals 1
...
.method public bridge synthetic getFMessage()LX/8tH;
    .locals 1
...
.method public onWindowVisibilityChanged(I)V
    ...
    iget-object v1, p0, LX/BRV;->A00:LX/3El;

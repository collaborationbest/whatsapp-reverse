...
.method public constructor <init>(Landroid/content/Context;LX/4aG;LX/2dL;)V
    ...
    invoke-direct {p0, p1, p2, p3}, LX/2HV;-><init>(Landroid/content/Context;LX/4aG;LX/2dL;)V

    invoke-virtual {p0}, LX/BRQ;->A0w()V

    return-void
.end method

.method public static A0F(LX/0uf;LX/1Sx;LX/2Gp;)V
    .locals 1

    iget-object v0, p1, LX/1Sx;->A0A:LX/005;
    ...
    invoke-static {p2, v0}, LX/2tR;->A00(LX/2H8;LX/4TF;)V

    invoke-static {p0}, LX/0uf;->A0o(LX/0uf;)LX/0ug;

    move-result-object v0

    invoke-static {v0}, LX/0ug;->AQM(LX/0ug;)LX/005;
    ...
    invoke-static {p2, v0}, LX/3RX;->A00(LX/2Gp;LX/3Sf;)V

    invoke-static {p0}, LX/0uf;->ApW(LX/0uf;)LX/005;
    ...
    invoke-static {p2, v0}, LX/3RX;->A02(LX/2Gp;LX/1GR;)V

    invoke-static {p0}, LX/0uf;->AoI(LX/0uf;)LX/005;
    ...
    invoke-static {p2, v0}, LX/3RX;->A01(LX/2Gp;LX/1H1;)V
...
.method public A0w()V
    ...
    iget-boolean v0, p0, LX/BRQ;->A00:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/BRQ;->A00:Z
    ...
    iget-object v0, v5, LX/1Sx;->A0A:LX/005;
    ...
    invoke-static {v4, v0}, LX/2tR;->A00(LX/2H8;LX/4TF;)V

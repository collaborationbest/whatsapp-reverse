...
.method public constructor <init>()V
    ...
    iput-boolean v9, p0, LX/BXb;->systemicRiskEnable:Z

    iput-boolean v9, p0, LX/BXb;->systemicRiskEnableForStories:Z

    iput-boolean v9, p0, LX/BXb;->systemicRiskEnableForPrefetch:Z

    const-wide v7, 0x3ff3333333333333L    # 1.2

    iput-wide v7, p0, LX/BXb;->systemicRiskLowMosFactor:D

    const-wide/16 v5, 0x0

    iput-wide v5, p0, LX/BXb;->systemicRiskLowMosFactorForIgClips:D

    const-wide/high16 v0, 0x4000000000000000L    # 2.0

    iput-wide v0, p0, LX/BXb;->systemicRiskFactor:D

    iput-wide v5, p0, LX/BXb;->systemRiskFactorForIgClips:D

    iput-wide v5, p0, LX/BXb;->systemicRiskFactorForBgPrefetch:D

    iput-wide v5, p0, LX/BXb;->systemicRiskLowMosFactorForBgPrefetch:D

    const/16 v2, 0x7d0

    iput v2, p0, LX/BXb;->systemicRiskAvgSegmentDurationMs:I

    iput v9, p0, LX/BXb;->systemicRiskMaxLookaheadDurationMs:I

    iput-boolean v9, p0, LX/BXb;->liveSystemicRiskEnable:Z

    iput v2, p0, LX/BXb;->liveSystemicRiskAvgSegmentDurationMs:I

    iput-wide v0, p0, LX/BXb;->liveSystemicRiskFactor:D

    iput-wide v7, p0, LX/BXb;->liveSystemicRiskLowMosFactor:D

    iput v9, p0, LX/BXb;->liveSystemicRiskMaxLookaheadDurationMs:I

    const-wide/high16 v3, 0x3ff0000000000000L    # 1.0

    iput-wide v3, p0, LX/BXb;->systemicRiskModMosFactor:D

    const/16 v2, 0x41

    iput v2, p0, LX/BXb;->modBwRiskConfPct:I

    const/high16 v10, 0x44480000    # 800.0f

    iput v10, p0, LX/BXb;->bwWeightLimitForBWEDampening:F

    const/high16 v10, 0x43960000    # 300.0f

    iput v10, p0, LX/BXb;->ttfbWeightLimitForBWEDampening:F

    iput-boolean v9, p0, LX/BXb;->systemicRiskAudioEnable:Z

    iput-boolean v9, p0, LX/BXb;->systemicRiskAudioEnableABR:Z

    iput-boolean v9, p0, LX/BXb;->systemicRiskAudioEnableDynOtherBitrate:Z

    iput-wide v0, p0, LX/BXb;->systemicRiskAudioFactor:D

    iput-wide v7, p0, LX/BXb;->systemicRiskAudioLowMosFactor:D

    iput-wide v3, p0, LX/BXb;->systemicRiskAudioBitrateBoostFactor:D

    iput v9, p0, LX/BXb;->systemicRiskAudioOtherBitrate:I

    iput-boolean v9, p0, LX/BXb;->liveSystemicRiskAudioEnable:Z

    iput-boolean v9, p0, LX/BXb;->liveSystemicRiskAudioEnableABR:Z

    iput-boolean v9, p0, LX/BXb;->liveSystemicRiskAudioEnableDynOtherBitrate:Z

    iput-wide v0, p0, LX/BXb;->liveSystemicRiskAudioFactor:D

    iput-wide v7, p0, LX/BXb;->liveSystemicRiskAudioLowMosFactor:D

    iput-wide v3, p0, LX/BXb;->liveSystemicRiskAudioBitrateBoostFactor:D

    iput v9, p0, LX/BXb;->liveSystemicRiskAudioOtherBitrate:I

    iput-boolean v9, p0, LX/BXb;->enableAudioBandwidthSamples:Z

    iput-wide v5, p0, LX/BXb;->virtualBufferPercent:D

    iput-wide v5, p0, LX/BXb;->liveVirtualBufferPercent:D

    iput-wide v5, p0, LX/BXb;->liveLSBVirtualBufferPercent:D

    iput-wide v5, p0, LX/BXb;->liveULSBVirtualBufferPercent:D

    iput-wide v5, p0, LX/BXb;->riskAdjFactor:D

    iput-wide v5, p0, LX/BXb;->audioRiskAdjFactor:D

    iput-wide v5, p0, LX/BXb;->liveRiskAdjFactor:D

    iput-wide v5, p0, LX/BXb;->liveAudioRiskAdjFactor:D

    iput-wide v5, p0, LX/BXb;->liveUserLowLatencyRiskAdjFactor:D

    iput-wide v5, p0, LX/BXb;->liveUserLowLatencySystemicRiskFactor:D

    iput-wide v5, p0, LX/BXb;->liveUserUltraLowLatencyRiskAdjFactor:D

    iput-wide v5, p0, LX/BXb;->liveUserUltraLowLatencySystemicRiskFactor:D

    const/4 v10, -0x1

    iput v10, p0, LX/BXb;->ultraLowLatencyAdjustedLowestQualityIndex:I

    iput-wide v5, p0, LX/BXb;->personalizedVirtualBufferPercent:D

    iput-wide v3, p0, LX/BXb;->personalizedRiskMultiplierVeryConservative:D

    iput-wide v3, p0, LX/BXb;->personalizedRiskMultiplierConservative:D

    iput-wide v3, p0, LX/BXb;->personalizedRiskMultiplierAggressive:D

    iput-wide v3, p0, LX/BXb;->personalizedRiskMultiplierVeryAggressive:D

    const/16 v12, 0x55

    iput v12, p0, LX/BXb;->personalizedBWRiskConfPctVeryConservative:I

    const/16 v11, 0x50

    iput v11, p0, LX/BXb;->personalizedBWRiskConfPctConservative:I

    const/16 v8, 0x4b

    iput v8, p0, LX/BXb;->personalizedBWRiskConfPctNormal:I

    const/16 v7, 0x46

    iput v7, p0, LX/BXb;->personalizedBWRiskConfPctAggressive:I

    iput v2, p0, LX/BXb;->personalizedBWRiskConfPctVeryAggressive:I

    const-wide/32 v0, 0x1d4c0

    iput-wide v0, p0, LX/BXb;->personalizedAggressiveStallDuration:J

    const-wide/32 v0, 0x493e0

    iput-wide v0, p0, LX/BXb;->personalizedVeryAggressiveStallDuration:J

    const-wide/16 v0, 0x7530

    iput-wide v0, p0, LX/BXb;->personalizedConservativeStallDuration:J

    iput-boolean v9, p0, LX/BXb;->shouldUseServerSideGoodput:Z

    iput-boolean v9, p0, LX/BXb;->shouldLogInbandTelemetryBweDebugString:Z

    iput v10, p0, LX/BXb;->ttfbMsecWithServerSideGoodput:I

    iput-wide v5, p0, LX/BXb;->livePersonalizedVirtualBufferPercent:D

    iput-wide v3, p0, LX/BXb;->livePersonalizedRiskMultiplierVeryConservative:D

    iput-wide v3, p0, LX/BXb;->livePersonalizedRiskMultiplierConservative:D

    iput-wide v3, p0, LX/BXb;->livePersonalizedRiskMultiplierAggressive:D

    iput-wide v3, p0, LX/BXb;->livePersonalizedRiskMultiplierVeryAggressive:D

    iput v12, p0, LX/BXb;->livePersonalizedBWRiskConfPctVeryConservative:I

    iput v11, p0, LX/BXb;->livePersonalizedBWRiskConfPctConservative:I

    iput v8, p0, LX/BXb;->livePersonalizedBWRiskConfPctNormal:I

    iput v7, p0, LX/BXb;->livePersonalizedBWRiskConfPctAggressive:I

    iput v2, p0, LX/BXb;->livePersonalizedBWRiskConfPctVeryAggressive:I

    const/16 v0, 0x32

    iput v0, p0, LX/BXb;->liveDefaultBwRiskConfPct:I

    iput v0, p0, LX/BXb;->defaultBwRiskConfPct:I

    iput v8, p0, LX/BXb;->liveHighBwRiskConfPct:I

    iput v8, p0, LX/BXb;->liveHighBwRiskConfPctUltraLowLatency:I

    iput v8, p0, LX/BXb;->highBwRiskConfPct:I

    iput v9, p0, LX/BXb;->adHighBwRiskConfPct:I

    iput v9, p0, LX/BXb;->adHighBwRiskConfPctOnScreen:I

    iput v9, p0, LX/BXb;->adHighBwRiskConfPctPrefetch:I

    iput v9, p0, LX/BXb;->backgroundPrefetchHighBwRiskConfPct:I

    iput v9, p0, LX/BXb;->foregroundPrefetchHighBwRiskConfPct:I

    iput-boolean v9, p0, LX/BXb;->enableConfRiskBwCache:Z

    iput-boolean v9, p0, LX/BXb;->shouldDeprecateLiveInitialABR:Z

    iput-boolean v9, p0, LX/BXb;->shouldCountFirstChunkOnly:Z

    iput-boolean v9, p0, LX/BXb;->honorDefaultBandwidthSR:Z

    iput-boolean v9, p0, LX/BXb;->enableBsrV2Definition:Z

    const/4 v7, 0x1

    iput-boolean v7, p0, LX/BXb;->bypassWidthLimitsSponsoredVerticalVideos:Z

    iput v9, p0, LX/BXb;->maxNumberSmallBwSamplesIgnored:I

    iput-boolean v9, p0, LX/BXb;->enableInitialBWStdDevFix:Z

    iput-boolean v9, p0, LX/BXb;->disableLiveDefaultDataSourceBwSamples:Z

    iput-boolean v9, p0, LX/BXb;->shouldDeleteNonSR:Z

    iput-wide v5, p0, LX/BXb;->smartCacheOverrideThreshold:D

    iput-wide v5, p0, LX/BXb;->smartCacheOverridePrefetchThreshold:D

    iput-wide v5, p0, LX/BXb;->highOrBetterMosThreshold:D

    iput-boolean v9, p0, LX/BXb;->enableDelayedPrefetchQualitySelection:Z

    iput-boolean v9, p0, LX/BXb;->useUnifiedUploadMos:Z

    iput-boolean v9, p0, LX/BXb;->usePlaybackCsvqm:Z

    iput-boolean v9, p0, LX/BXb;->useOverallMosForABR:Z

    iput-wide v5, p0, LX/BXb;->minOverallMosForABR:D

    iput-wide v5, p0, LX/BXb;->modOverallMosForABR:D

    iput-boolean v7, p0, LX/BXb;->usePlaybackMosForLowMosABR:Z

    iput-boolean v9, p0, LX/BXb;->enableXPlatBweParity:Z

    iput-boolean v9, p0, LX/BXb;->useXPlatBwe:Z

    iput-boolean v9, p0, LX/BXb;->enableAndroidAPIBitrate:Z

    iput v10, p0, LX/BXb;->androidBandwidthFallbackNumberOfSamples:I

    iput-boolean v7, p0, LX/BXb;->xplatUseLowPassFilter:Z

    iput-wide v3, p0, LX/BXb;->xplatLowPassFilterAlphaMultiplier:D

    const-wide/16 v0, 0x14

    iput-wide v0, p0, LX/BXb;->xplatWindowSizeSeconds:J

    const-wide/16 v0, 0xa

    iput-wide v0, p0, LX/BXb;->xplatWindowMinSamples:J

    const-wide/16 v0, 0x2710

    iput-wide v0, p0, LX/BXb;->xplatSizeThreshBytes:J

    const-wide v0, 0x3fb999999999999aL    # 0.1

    iput-wide v0, p0, LX/BXb;->xplatAlphaBitrate:D

    const-wide/high16 v0, 0x3fd0000000000000L    # 0.25

    iput-wide v0, p0, LX/BXb;->xplatAlphaLatency:D

    const-wide/16 v0, -0x1

    iput-wide v0, p0, LX/BXb;->xplatMaxNumSmallSamplesIgnored:J

    const/16 v0, 0x280

    iput v0, p0, LX/BXb;->maxWidthToPrefetchAbr:I

    const/16 v0, 0x1e0

    iput v0, p0, LX/BXb;->maxWidthToPrefetchAbrCell:I

    const/16 v0, 0x2d0

    iput v0, p0, LX/BXb;->maxWidthInlinePlayer:I

    const/16 v0, 0x1e0

    iput v0, p0, LX/BXb;->maxWidthCell:I

    iput v9, p0, LX/BXb;->maxWidthSphericalVideo:I

    const v0, 0xc350

    iput v0, p0, LX/BXb;->maxInitialBitrate:I

    iput-boolean v9, p0, LX/BXb;->enableInitialBitrateBoosterByNetworkQuality:Z

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, LX/BXb;->initialBitrateBoosterByNetworkQuality:F

    const/16 v0, 0x61a8

    iput v0, p0, LX/BXb;->maxDurationForQualityDecreaseMs:I

    const/16 v0, 0x5a

    iput v0, p0, LX/BXb;->lowBufferBandwidthConfidencePct:I

    iput v2, p0, LX/BXb;->highBufferBandwidthConfidencePct:I

    iput v10, p0, LX/BXb;->prefetchLongQueueBandwidthConfidencePct:I

    iput v10, p0, LX/BXb;->prefetchShortQueueBandwidthConfidencePct:I

    const v0, 0x3e99999a    # 0.3f

    iput v0, p0, LX/BXb;->minBandwidthMultiplier:F

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, LX/BXb;->bandwidthMultiplier:F

    const v0, 0x3e99999a    # 0.3f

    iput v0, p0, LX/BXb;->storiesMinBandwidthMultiplier:F

    const/high16 v0, 0x40000000    # 2.0f

    iput v0, p0, LX/BXb;->maxBandwidthMultiplier:F

    iput v0, p0, LX/BXb;->storiesMaxBandwidthMultiplier:F

    const/high16 v0, 0x40400000    # 3.0f

    iput v0, p0, LX/BXb;->maxTTFBMultiplier:F

    iput v0, p0, LX/BXb;->storiesMaxTTFBMultiplier:F

    const/high16 v0, 0x3f000000    # 0.5f

    iput v0, p0, LX/BXb;->minTTFBMultiplier:F

    iput v0, p0, LX/BXb;->storiesMinTTFBMultiplier:F

    const/4 v0, 0x0

    iput v0, p0, LX/BXb;->prefetchBandwidthFraction:F

    const/16 v0, 0xbb8

    iput v0, p0, LX/BXb;->latencyBasedTargetBufferSizeMs:I

    iput v9, p0, LX/BXb;->storyLatencyBasedTargetBufferSizeMs:I

    iput v10, p0, LX/BXb;->veryHighBufferDurationMsForBandwidthBoost:I

    iput v10, p0, LX/BXb;->veryHighBufferDurationMsForBandwidthBoostIG:I

    iput v9, p0, LX/BXb;->latencyBasedTargetBufferDrainDurationMs:I

    iput-boolean v9, p0, LX/BXb;->enableAvoidOnCellular:Z

    iput v9, p0, LX/BXb;->minMosConstraintLimit:I

    const/high16 v0, 0x40000000    # 2.0f

    iput v0, p0, LX/BXb;->vodPrefetchDurationMultiplier:F

    iput-boolean v9, p0, LX/BXb;->bypassWidthLimitsStories:Z

    iput-boolean v9, p0, LX/BXb;->bypassWidthLimitsStoriesPrefetch:Z

    iput-boolean v9, p0, LX/BXb;->enableSegmentBitrate:Z

    iput-boolean v9, p0, LX/BXb;->shouldFilterHardwareCapabilities:Z

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, LX/BXb;->minPartiallyCachedSpan:F

    const/high16 v0, 0x3f000000    # 0.5f

    iput v0, p0, LX/BXb;->prefetchLongQueueBandwidthFraction:F

    const/high16 v0, 0x3f400000    # 0.75f

    iput v0, p0, LX/BXb;->prefetchShortQueueBandwidthFraction:F

    const/4 v0, 0x3

    iput v0, p0, LX/BXb;->prefetchLongQueueSizeThreshold:I

    iput-boolean v9, p0, LX/BXb;->hashUrlForUnique:Z

    const v0, 0x3f99999a    # 1.2f

    iput v0, p0, LX/BXb;->screenWidthMultiplierLandscapeVideo:F

    iput v0, p0, LX/BXb;->screenWidthMultiplierPortraitVideo:F

    iput-boolean v9, p0, LX/BXb;->enableCdnBandwidthRestriction:Z

    const v0, 0xc350

    iput v0, p0, LX/BXb;->audioMaxInitialBitrate:I

    iput-boolean v9, p0, LX/BXb;->enableMultiAudioSupport:Z

    iput-boolean v9, p0, LX/BXb;->enableAudioIbrEvaluator:Z

    iput-boolean v9, p0, LX/BXb;->allowAudioFormatsLowerThanDefault:Z

    iput-boolean v9, p0, LX/BXb;->enableAudioIbrCache:Z

    iput-boolean v9, p0, LX/BXb;->enableAudioAbrEvaluator:Z

    iput-boolean v9, p0, LX/BXb;->enableAudioAbrPairing:Z

    iput-boolean v9, p0, LX/BXb;->enableAudioAbrSecondPhaseEvaluation:Z

    iput-boolean v9, p0, LX/BXb;->enableBufferBasedAudioAbrEvaluation:Z

    iput v9, p0, LX/BXb;->minWatchableMos:I

    iput v9, p0, LX/BXb;->igClipsMinWatchableMos:I

    const/4 v0, 0x0

    iput v0, p0, LX/BXb;->softMinMosForAbrSelector:F

    iput-boolean v9, p0, LX/BXb;->allowAbrUpToWatchableMosInLowBuffer:Z

    iput-boolean v9, p0, LX/BXb;->treatShortFormAsStories:Z

    iput v0, p0, LX/BXb;->softMinMosBandwidthFractionForAbrSelector:F

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, p0, LX/BXb;->minVisualQualityScore:F

    const/4 v0, 0x0

    iput v0, p0, LX/BXb;->audioBandwidthFractionWifi:F

    iput v0, p0, LX/BXb;->audioBandwidthFractionCell:F

    iput v0, p0, LX/BXb;->audioPrefetchBandwidthFraction:F

    iput-boolean v9, p0, LX/BXb;->treatCurrentNullAsLowBuffer:Z

    const v0, 0x3f19999a    # 0.6f

    iput v0, p0, LX/BXb;->mainProcessBitrateEstimateMultiplier:F

    iput-boolean v9, p0, LX/BXb;->skipCachedAsCurrent:Z

    iput v10, p0, LX/BXb;->minDurationForHighBWQualityIncreaseMs:I

    iput v10, p0, LX/BXb;->storiesMinDurationForHighBWQualityIncreaseMs:I

    iput-boolean v9, p0, LX/BXb;->enableTtfbOnlyEstimation:Z

    iput-boolean v9, p0, LX/BXb;->enableBwOnlyEstimationForLongPoll:Z

    iput-boolean v9, p0, LX/BXb;->removeCDNResponseTimeForLongPoll:Z

    iput-boolean v9, p0, LX/BXb;->useDefaultFormatAsBackupForScreenWidthConstraints:Z

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, LX/BXb;->lambdaFallingBufferConfidenceCalculator:F

    iput v0, p0, LX/BXb;->lambdaRisingBufferConfidenceCalculator:F

    const/16 v0, 0x61a8

    iput v0, p0, LX/BXb;->maxBufferedDurationMsFallingBuffer:I

    iput v0, p0, LX/BXb;->storiesMaxBufferedDurationMsFallingBuffer:I

    iput-boolean v9, p0, LX/BXb;->useMosAwareCachedSelection:Z

    iput v9, p0, LX/BXb;->storiesMinMosForCachedQuality:I

    iput v9, p0, LX/BXb;->minMosForCachedQuality:I

    iput v9, p0, LX/BXb;->storiesMosDiffPctForCachedQuality:I

    iput v9, p0, LX/BXb;->mosDiffPctForCachedQuality:I

    iput v9, p0, LX/BXb;->minBufferedDurationMsForMosAwareCache:I

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, LX/BXb;->dropRenderFrameRatioForPreventAbrUp:F

    iput v9, p0, LX/BXb;->minFramesDropForPreventAbrUp:I

    iput v9, p0, LX/BXb;->minFramesRenderedForPreventAbrUp:I

    const/4 v0, 0x0

    iput v0, p0, LX/BXb;->minWidthMultiplierFrameDrop:F

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, LX/BXb;->frameDropFactor:F

    iput-boolean v7, p0, LX/BXb;->forceCurrentNoWatchableFormatFrameDrop:Z

    iput-boolean v9, p0, LX/BXb;->forceUpdateFormatListIfFormatSizeChanged:Z

    iput-boolean v9, p0, LX/BXb;->bypassPrefetchWidthLimits:Z

    iput-boolean v9, p0, LX/BXb;->shouldEnableAvoidOnABR:Z

    const/16 v0, 0x2710

    iput v0, p0, LX/BXb;->ssAbrSampleMaxValidTimeMs:I

    const/16 v0, 0x7530

    iput v0, p0, LX/BXb;->ssAbrSampleMaxValidTimeAcrossVideosMs:I

    iput-boolean v9, p0, LX/BXb;->useRiskRewardRatio:Z

    iput-boolean v9, p0, LX/BXb;->selectIntermediateFormatRiskRewardBased:Z

    const/4 v0, 0x0

    iput v0, p0, LX/BXb;->riskRewardRatioLowerBound:F

    iput v0, p0, LX/BXb;->riskRewardRatioUpperBound:F

    iput v9, p0, LX/BXb;->riskRewardRatioBufferLimitMs:I

    iput-boolean v9, p0, LX/BXb;->useLogarithmicRisk:Z

    const/16 v0, 0x2d0

    iput v0, p0, LX/BXb;->liveMaxWidthCell:I

    const/16 v0, 0x3e8

    iput v0, p0, LX/BXb;->liveMaxWidthInlinePlayer:I

    const/16 v0, 0x1388

    iput v0, p0, LX/BXb;->liveMinDurationForQualityIncreaseMs:I

    const/16 v0, 0x61a8

    iput v0, p0, LX/BXb;->liveMaxDurationForQualityDecreaseMs:I

    const v0, 0x3f666666    # 0.9f

    iput v0, p0, LX/BXb;->liveExtraBandwidthFractionForQualityIncrease:F

    const/16 v0, 0xbb8

    iput v0, p0, LX/BXb;->liveAbrLatencyBasedAbrTargetBufferSizeMs:I

    iput v12, p0, LX/BXb;->liveLowBufferBandwidthConfidencePct:I

    const/16 v0, 0x3c

    iput v0, p0, LX/BXb;->liveHighBufferBandwidthConfidencePct:I

    iput v10, p0, LX/BXb;->livePrefetchLongQueueBandwidthConfidencePct:I

    iput v10, p0, LX/BXb;->livePrefetchShortQueueBandwidthConfidencePct:I

    const v0, 0x3e99999a    # 0.3f

    iput v0, p0, LX/BXb;->liveMinBandwidthMultiplier:F

    const/high16 v0, 0x40000000    # 2.0f

    iput v0, p0, LX/BXb;->liveMaxBandwidthMultiplier:F

    const/high16 v0, 0x40400000    # 3.0f

    iput v0, p0, LX/BXb;->liveMaxTTFBMultiplier:F

    const/high16 v0, 0x3f000000    # 0.5f

    iput v0, p0, LX/BXb;->liveMinTTFBMultiplier:F

    iput-boolean v9, p0, LX/BXb;->liveShouldAvoidOnCellular:Z

    const/high16 v0, 0x40000000    # 2.0f

    iput v0, p0, LX/BXb;->livePrefetchDurationMultiplier:F

    iput v9, p0, LX/BXb;->liveAbrDefaultMaxWidthCell:I

    iput v9, p0, LX/BXb;->liveAbrDefaultMaxWidthWifi:I

    const/16 v0, 0x18c

    iput v0, p0, LX/BXb;->liveMaxWidthToPrefetchCell:I

    const/16 v0, 0x1f8

    iput v0, p0, LX/BXb;->liveMaxWidthToPrefetchWifi:I

    const/high16 v0, 0x3e800000    # 0.25f

    iput v0, p0, LX/BXb;->liveAbrPrefetchLongQueueBandwidthFraction:F

    const/high16 v0, 0x3f000000    # 0.5f

    iput v0, p0, LX/BXb;->liveAbrPrefetchShortQueueBandwidthFraction:F

    iput v7, p0, LX/BXb;->liveAbrPrefetchLongQueueSizeThreshold:I

    iput-boolean v9, p0, LX/BXb;->liveShouldFilterHardwareCapabilities:Z

    iput-boolean v9, p0, LX/BXb;->liveAvoidUseDefault:Z

    const v0, 0xc350

    iput v0, p0, LX/BXb;->liveInitialBitrate:I

    iput-boolean v9, p0, LX/BXb;->liveEnableInitialBitrateBoosterByNetworkQuality:Z

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, LX/BXb;->liveInitialBitrateBoosterByNetworkQuality:F

    iput-boolean v9, p0, LX/BXb;->livePredictiveABROnStdLive:Z

    iput v9, p0, LX/BXb;->livePredictiveABRUpBufferMs:I

    iput v9, p0, LX/BXb;->livePredictiveABRDownBufferMs:I

    iput v9, p0, LX/BXb;->livePredictiveABRUpRetryIntervalMs:I

    iput v9, p0, LX/BXb;->livePredictiveABRMaxSingleCycleDepletionLLMs:I

    iput v9, p0, LX/BXb;->livePredictiveABRUpBufferLLMs:I

    iput v9, p0, LX/BXb;->livePredictiveABRDownBufferLLMs:I

    iput v9, p0, LX/BXb;->livePredictiveABRUpRetryIntervalLLMs:I

    iput v9, p0, LX/BXb;->livePredictiveABRMaxSingleCycleDepletionMs:I

    const/4 v0, 0x0

    iput v0, p0, LX/BXb;->livePredictiveABRTtfbRatio:F

    iput-boolean v9, p0, LX/BXb;->livePredictiveABRUpOnLiveHead:Z

    const v0, 0x3f99999a    # 1.2f

    iput v0, p0, LX/BXb;->liveScreenWidthMultiplierLandscapeVideo:F

    iput v0, p0, LX/BXb;->liveScreenWidthMultiplierPortraitVideo:F

    iput-boolean v9, p0, LX/BXb;->liveTreatCurrentNullAsLowBuffer:Z

    const v0, 0x3f19999a    # 0.6f

    iput v0, p0, LX/BXb;->liveMainProcessBitrateEstimateMultiplier:F

    const-wide/16 v0, 0x0

    iput-wide v0, p0, LX/BXb;->liveAocDefaultLimitIntentionalKbps:J

    iput-wide v0, p0, LX/BXb;->liveAocDefaultLimitUnintentionalKbps:J

    iput-boolean v9, p0, LX/BXb;->alwaysPlayLiveCachedData:Z

    iput v9, p0, LX/BXb;->initSegmentBandwidthExclusionLimitBytes:I

    iput v10, p0, LX/BXb;->liveMinDurationForHighBWQualityIncreaseMs:I

    iput v10, p0, LX/BXb;->liveStoriesMinDurationForHighBWQualityIncreaseMs:I

    iput-boolean v9, p0, LX/BXb;->enableVodPrefetchQSFix:Z

    iput v9, p0, LX/BXb;->minMosForPrefetch:I

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, LX/BXb;->mosPrefetchFractionByNetworkQuality:F

    iput v0, p0, LX/BXb;->liveLambdaFallingBufferConfidenceCalculator:F

    iput v0, p0, LX/BXb;->liveLambdaRisingBufferConfidenceCalculator:F

    const/16 v0, 0x61a8

    iput v0, p0, LX/BXb;->liveMaxBufferedDurationMsFallingBuffer:I

    iput v0, p0, LX/BXb;->liveStoriesMaxBufferedDurationMsFallingBuffer:I

    iput-boolean v9, p0, LX/BXb;->liveEnableAudioIbrEvaluator:Z

    iput-boolean v9, p0, LX/BXb;->liveEnableAudioIbrCache:Z

    iput-boolean v9, p0, LX/BXb;->liveAllowAudioFormatsLowerThanDefault:Z

    const v0, 0xc350

    iput v0, p0, LX/BXb;->liveAudioMaxInitialBitrate:I

    const v0, 0x3c23d70a    # 0.01f

    iput v0, p0, LX/BXb;->liveAudioBandwidthFractionWifi:F

    iput v0, p0, LX/BXb;->liveAudioBandwidthFractionCell:F

    iput v0, p0, LX/BXb;->liveAudioPrefetchBandwidthFraction:F

    iput-boolean v9, p0, LX/BXb;->liveAllowAbrUpToWatchableMosInLowBuffer:Z

    iput-boolean v9, p0, LX/BXb;->serverSideForwardBwe:Z

    iput-boolean v9, p0, LX/BXb;->useSSBweForUltraLowLatency:Z

    iput-boolean v9, p0, LX/BXb;->useSSBweForLowLatency:Z

    iput-boolean v9, p0, LX/BXb;->useSSBweForRegularLatency:Z

    const-wide/16 v0, 0x0

    iput-wide v0, p0, LX/BXb;->initialCachedBwSizeBytes:J
